...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function il(e,t,n){let r=new Float32Array(Wc),i=new V(0,1,0);return new ts({name:`SphericalGaussianBlur`,defines:{n:Wc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:sl(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function al(){return new ts({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:sl(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ol(){return new ts({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sl(),fragmentShader:`
	...
	`}var cl=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ca(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Nu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Pu(e,t){let n=Nu[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Fu=new V;function Iu(){return U.getLuminanceCoefficients(Fu),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Fu.x.toFixed(4)}, ${Fu.y.toFixed(4)}, ${Fu.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Tu(i,i.VERTEX_SHADER,y),S=Tu(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=ju(i,x,`vertex`),n=ju(i,S,`fragment`);R(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    <br>  - Diagnosed and resolved hardware & software issues
    <br>  - Supported Quality Assurance Testing for computer upgrading
    <br>  - Explained technology updates to office team and customers<br><br>• 2021 (Aug, 136HR) | IT Business Analyst Trainee – Code Free Soft Limited<br>  - Performed business application of system automation and quality assurance<br>  - Developed simple business applications (HR System, Booking System, Express System) using DragOnce System`,skills:`
    - Programing Languages(Python, Java, .JS, HTML/CSS/PHP, MySQL, etc); 
    <br>- AI & Deep Learning; 
    <br>- IT Technical Support, Troubleshooting; 
    <br>- Quality Assurance Testing`,projects:`• Capstone Project (FYP2026): Emotion Recognition in Conversation with Deep Learning
    <br><br>• Final Year Project (2022): Flow-Based AR Game Editor 
    <br>- 2nd Runner-up in IFF2021 
    <br>- 2nd Runner-up Information Technology Category in YKIIP 
    <br>- Second Prize in 8th HK University Student Innovation & Entrepreneurship Competition`},skills:{programming:`Python, Java, PHP, C#, Swift, ABAP, C++`,databaseFrontend:`MySQL, HTML, JavaScript, CSS, JSON, JSP`,tools:`Microsoft Office, Photoshop, Audacity, Davinci Resolve, IT Technical Support, QA Testing, Big Data Analysis`,languages:`Cantonese (Native) • English (Intermediate) • Mandarin (Competent)`},galleryProjects:[{title:`Emotion Recognition in Conversation with Deep Learning`,subtitle:`(Capstone Project, 2025-2026)`,desc:`This study explores the limitations (5 Challenges) of Prev. ERC project and providing BERT & LLMs system to address these limitations`,images:[`./img/Capstone_Project2026/1.png`],detailImages:[`./img/Capstone_Project2026/0.png`,`./img/Capstone_Project2026/1.png`,`./img/Capstone_Project2026/2.png`,`./img/Capstone_Project2026/3.png`,`./img/Capstone_Project2026/4.png`,`./img/Capstone_Project2026/5.png`,`./img/Capstone_Project2026/6.png`,`./img/Capstone_Project2026/7.png`,`./img/Capstone_Project2026/8.png`,`./img/Capstone_Project2026/9.png`,`./img/Capstone_Project2026/10.png`,`./img/Capstone_Project2026/11.png`,`./img/Capstone_Project2026/12.png`,`./img/Capstone_Project2026/13.png`,`./img/Capstone_Project2026/14.png`,`./img/Capstone_Project2026/15.png`],link:`https://github.com/yeungzero0/Capstone-Project`},{title:`Anime Sketch to IMG `,subtitle:`(Personal Project, 2025-2026)`,desc:`Convert anime sketches into color images By using CNN. Supports PyTorch training and inference; To Implement Sketch → Colored Anime Image using CNN architecture. `,images:[`./img/AnimeSketch2026/0.png`],detailImages:[`./img/AnimeSketch2026/0.png`,`./img/AnimeSketch2026/1.png`,`./img/AnimeSketch2026/2.png`,`./img/AnimeSketch2026/3.png`,`./img/AnimeSketch2026/4.png`,`./img/AnimeSketch2026/5.png`],link:`https://github.com/yeungzero0/Anime-Sketch-to-IMG-CNN`},{title:`Recommendation-Comments-System`,subtitle:`(BIG-DATA-ANALYTICS, 2025)`,desc:`A "Helpfulness Prediction" system based on Amazon product reviews`,images:[`./img/RCS2025/0.png`],detailImages:[`./img/RCS2025/0.png`,`./img/RCS2025/1.png`,`./img/RCS2025/2.png`,`./img/RCS2025/3.png`,`./img/RCS2025/4.png`,`./img/RCS2025/5.png`],link:`https://github.com/yeungzero0/recommendation-comments-system--BIG-DATA-ANALYTICS-`},{title:`AIoT-Based - Simulation Smart Parking System`,subtitle:`(AIoT , 2025)`,desc:`Simulation an AIoT-based smart parking system combines hardware sensing, cloud data transmission`,images:[`./img/AIOT2025/0.png`],detailImages:[`./img/AIOT2025/0.png`,`./img/AIOT2025/1.png`,`./img/AIOT2025/2.png`,`./img/AIOT2025/3.png`,`./img/AIOT2025/4.png`,`./img/AIOT2025/5.png`],link:`https://github.com/yeungzero0/comp4436_AIoT_GroupProject`},{title:`Don't Overfit II `,subtitle:`(Kaggle, 2025)`,desc:`The main purpose is to understand and combat the overfitting problem`,images:[`./img/overfit2025/0.png`],detailImages:[`./img/overfit2025/0.png`],link:`https://github.com/yeungzero0/Don-t-Overfit--II---Kaggle`},{title:`Cat and Dog image classification`,subtitle:`(AI , 2025)`,desc:`Testing with </br>1.Logistic Regression, </br>2.K-Means; 3.CNN, </br>4.Autoencoder; 5.SNN x CNN`,images:[`./img/base_ML_DL2025/0.png`],detailImages:[`./img/base_ML_DL2025/0.png`],link:`https://github.com/yeungzero0/Comp4436_Assignment1_Group12_FinalVersion`},{title:`Secure File-Sharing System`,subtitle:`(Encryption , 2025)`,desc:`A secure file-sharing system with user registration/login, TOTP two-factor authentication, AES-GCM file encryption`,images:[`./img/Security_FileSharingSystem2025/0.png`],detailImages:[`./img/Security_FileSharingSystem2025/0.png`],link:`https://github.com/yeungzero0/COMP3334_Computer-Systems-Security-Project`},{title:`Flow-Based </br>AR Game Editor`,subtitle:`(FYP , 2022)`,desc:`Non-programming AR game editor, including 3d object capture & share data to firebase, etc. </br>2nd Runner-up in IFF2021 </br>2nd Runner-up in YKIIP...`,images:[`./img/AR_GameEditor2022/0.jpg`],detailImages:[`./img/AR_GameEditor2022/0.jpg`,`./img/AR_GameEditor2022/1.jpg`,`./img/AR_GameEditor2022/2.jpg`,`./img/AR_GameEditor2022/3.jpg`,`./img/AR_GameEditor2022/4.jpg`,`./img/AR_GameEditor2022/5.jpg`,`./img/AR_GameEditor2022/6.jpg`,`./img/AR_GameEditor2022/7.jpg`,`./img/AR_GameEditor2022/8.jpg`,`./img/AR_GameEditor2022/9.jpg`,`./img/AR_GameEditor2022/10.jpg`],link:``}]},vf=null,yf=[],bf=null,xf=null,Sf=null,J={isArcadeGameOpen:!1,currentBGMVolume:.15,ag3PersistentBalance:7e3,audioManager:{mainBGM:null,currentGameBGM:null,isMuted:!1}};function Cf(){try{bf||(bf=new Audio(`./music/ag1_jump.mp3`),bf.volume=.6),bf.currentTime=0,bf.play().catch(()=>{})}catch{}}function wf(){try{xf||(xf=new Audio(`./music/ag1_gameover.mp3`),xf.volume=.75),xf.currentTime=0,xf.play().catch(()=>{})}catch{}}function Tf(){try{Sf||(Sf=new Audio(`./music/fireworks_se.mp3`),Sf.volume=.7),Sf.currentTime=0,Sf.play().catch(()=>{})}catch{console.warn(`煙火音效播放失敗`)}}function Ef(e){J.audioManager.mainBGM&&J.audioManager.mainBGM.pause(),J.audioManager.currentGameBGM&&(J.audioManager.currentGameBGM.pause(),J.audioManager.currentGameBGM=null);let t=``;if(e===`ag1`&&(t=`./music/ag1_main.mp3`),e===`ag2`&&(t=`./music/ag2_main.mp3`),e===`ag3`&&(t=`./music/ag3_main.mp3`),e===`ag4`&&(t=`./music/ag3_main.mp3`),!t)return;J.audioManager.currentGameBGM=new Audio(t),J.audioManager.currentGameBGM.loop=!0;let n=J.audioManager.isMuted?0:J.currentBGMVolume;J.audioManager.currentGameBGM.volume=n,J.audioManager.isMuted||J.audioManager.currentGameBGM.play().catch(()=>{})}function Df(){J.audioManager.currentGameBGM&&(J.audioManager.currentGameBGM.pause(),J.audioManager.currentGameBGM=null),J.audioManager.mainBGM&&(J.audioManager.mainBGM.volume=J.currentBGMVolume,J.audioManager.mainBGM.play().catch(()=>{}))}function Of(){J.audioManager.mainBGM=new Audio(`./music/main_bgm.mp3`),J.audioManager.mainBGM.loop=!0,J.audioManager.mainBGM.volume=J.currentBGMVolume;let e=()=>{!J.audioManager.isMuted&&J.audioManager.mainBGM.paused&&J.audioManager.mainBGM.play().catch(()=>{}),window.removeEventListener(`click`,e),window.removeEventListener(`keydown`,e)};window.addEventListener(`click`,e,{once:!0}),window.addEventListener(`keydown`,e,{once:!0}),console.log(`%c🎵 主 BGM 已準備（點擊畫面或按任意鍵後自動播放）`,`color:#00ff88`)}function kf(){J.audioManager.isMuted=!J.audioManager.isMuted,J.audioManager.isMuted?(J.audioManager.mainBGM&&(J.audioManager.mainBGM.volume=0),J.audioManager.currentGameBGM&&(J.audioManager.currentGameBGM.volume=0),console.log(`%c🔇 BGM 已靜音 (M)`,`color:#ffff00`)):J.isArcadeGameOpen&&J.audioManager.currentGameBGM?(J.audioManager.currentGameBGM.paused&&J.audioManager.currentGameBGM.play().catch(()=>{}),J.audioManager.currentGameBGM.volume=J.currentBGMVolume,console.log(`%c🔊 遊戲 BGM 已開啟 (M)`,`color:#00ffff`)):(J.audioManager.mainBGM&&(J.audioManager.mainBGM.paused&&J.audioManager.mainBGM.play().catch(()=>{}),J.audioManager.mainBGM.volume=J.currentBGMVolume),console.log(`%c🔊 主 BGM 已開啟 (M)`,`color:#ffff00`))}function Af(e){J.audioManager.isMuted||(J.currentBGMVolume=Math.max(0,Math.min(1,J.currentBGMVolume+e)),J.audioManager.mainBGM&&(J.audioManager.mainBGM.volume=J.currentBGMVolume),J.audioManager.currentGameBGM&&(J.audioManager.currentGameBGM.volume=J.currentBGMVolume),console.log(`%c🔊 BGM 音量: `+Math.round(J.currentBGMVolume*100)+`%`,`color:#00ffff`))}function jf(){let e=document.createElement(`div`);return e.id=`arcade-modal`,e.style.display=`none`,e.innerHTML=`
    <div style="position: absolute; top: 20px; right: 30px; font-size: 42px; color: #ff00ff; cursor: pointer; text-shadow: 0 0 20px #ff00ff;" id="close-arcade">✕</div>
    
    <div style="color: #00ffff; font-size: 28px; margin-bottom: 20px; text-shadow: 0 0 15px #00ffff;">
      🕹️ ARCADE MACHINE
    </div>
    
    <div id="game-container" style="width: 820px; height: 520px; background: #000; border: 4px solid #ffff00; position: relative; overflow: hidden;">
      <!-- 遊戲畫面會插在這裡 -->
    </div>
    
    <div style="margin-top: 15px; color: #ffff00; font-size: 16px;">
      Press <span style="color:#ff00ff; font-weight:bold;">ESC</span> to exit game
    </div>
  `,document.body.appendChild(e),e.querySelector(`#close-arcade`).onclick=tp,document.addEventListener(`keydown`,t=>{t.key===`Escape`&&e.style.display===`flex`&&tp()}),e}function Mf(){if(J.isArcadeGameOpen=!0,vf||=jf(),vf.style.display===`flex`)return;vf.style.display=`flex`,Ef(`ag1`);let e=document.getElementById(`game-container`);e.innerHTML=`
    <canvas id="ag1-canvas" width="815" height="400" 
            style="display:block; background:#0a001f; border: 3px solid #00ffff;"></canvas>
    <div id="ag1-ui" style="position:absolute; top:10px; left:10px; color:#ffff00; font-family:monospace; font-size:18px;">
      SCORE: <span id="ag1-score">00000</span>
    </div>
  `;let t=vf.querySelector(`div[style*="color: #00ffff"]`);t&&(t.innerHTML=`🕹️ ARCADE MACHINE — AG1 小恐龍(Fake)`),Nf()}var Y={};function Nf(){let e=document.getElementById(`ag1-canvas`),t=e.getContext(`2d`);Y={dino:{x:80,y:300,width:40,height:45,vy:0,onGround:!0},obstacles:[],score:0,gameSpeed:4.5,gravity:.85,jumpForce:-16.5,lastTime:Date.now(),isGameOver:!1,particles:[],minSpawnInterval:900,maxSpawnInterval:1700,nextSpawnTime:0,animationFrameId:null},document.removeEventListener(`keydown`,n),document.addEventListener(`keydown`,n);function n(e){Y.isGameOver&&e.key.toLowerCase()===`r`&&Nf(),(e.key===` `||e.key===`ArrowUp`)&&Y.dino.onGround&&(Y.dino.vy=Y.jumpForce,Y.dino.onGround=!1,J.isArcadeGameOpen!=0&&Cf()),e.key.toLowerCase()===`Escape`&&tp()}function r(){if(!e||Y.isGameOver)return;t.fillStyle=`#0a001f`,t.fillRect(0,0,e.width,e.height);let n=Date.now();Y.score+=.016*Y.gameSpeed,document.getElementById(`ag1-score`).innerText=Math.floor(Y.score).toString().padStart(5,`0`),Math.floor(Y.score)>0&&Math.floor(Y.score)%100==0&&(Tf(),Pf(e.width/2,80),setTimeout(()=>{Tf(),Pf(e.width/2,200)},800),setTimeout(()=>{Tf(),Pf(e.width/1.75,40)},1600),setTimeout(()=>{Tf(),Pf(e.width/1.45,140)},2400),Pf(e.width/1.45,64));let i=Y.dino;if(i.vy+=Y.gravity,i.y+=i.vy,i.y>=300&&(i.y=300,i.vy=0,i.onGround=!0),t.fillStyle=`#00ff88`,t.fillRect(i.x,i.y,i.width,i.height),t.fillStyle=`#ffffff`,t.fillRect(i.x+25,i.y+10,8,8),n>Y.nextSpawnTime){Y.obstacles.push({x:e.width+20,y:305,width:22+Math.random()*12,height:40+Math.random()*15});let t=Y.minSpawnInterval+Math.random()*(Y.maxSpawnInterval-Y.minSpawnInterval);Y.nextSpawnTime=n+t}for(let n=Y.obstacles.length-1;n>=0;n--){let r=Y.obstacles[n];r.x-=Y.gameSpeed,t.fillStyle=`#ffaa00`,t.fillRect(r.x,r.y,r.width,r.height),i.x<r.x+r.width&&i.x+i.width>r.x&&i.y<r.y+r.height&&i.y+i.height>r.y&&(Y.isGameOver=!0,Ff(e)),r.x<-60&&Y.obstacles.splice(n,1)}for(let e=Y.particles.length-1;e>=0;e--){let n=Y.particles[e];n.x+=n.vx,n.y+=n.vy,n.vy+=.25,--n.life,t.fillStyle=`hsla(${n.hue}, 100%, 75%, ${n.life/28})`,t.fillRect(n.x,n.y,5,5),n.life<=0&&Y.particles.splice(e,1)}Y.score>100&&(Y.gameSpeed=5.2,Y.maxSpawnInterval=Math.max(680,Y.maxSpawnInterval-1.2),Y.minSpawnInterval=620),Y.score>200&&(Y.gameSpeed=5.9,Y.maxSpawnInterval=Math.max(580,Y.maxSpawnInterval-1.1),Y.minSpawnInterval=520),Y.score>300&&(Y.gameSpeed=6.6,Y.maxSpawnInterval=Math.max(520,Y.maxSpawnInterval-1),Y.minSpawnInterval=460),Y.score>400&&(Y.gameSpeed=7.4,Y.maxSpawnInterval=Math.max(480,Y.maxSpawnInterval-.9),Y.minSpawnInterval=400),Y.score>500&&(Y.gameSpeed=8.2,Y.maxSpawnInterval=Math.max(420,Y.maxSpawnInterval-.85),Y.minSpawnInterval=360),Y.score>600&&(Y.gameSpeed=9,Y.maxSpawnInterval=Math.max(380,Y.maxSpawnInterval-.8),Y.minSpawnInterval=320),Y.score>700&&(Y.gameSpeed=10,Y.maxSpawnInterval=Math.max(320,Y.maxSpawnInterval-.75),Y.minSpawnInterval=280),Y.score>800&&(Y.gameSpeed=11,Y.maxSpawnInterval=Math.max(280,Y.maxSpawnInterval-.7),Y.minSpawnInterval=240),Y.animationFrameId=requestAnimationFrame(r)}Y.nextSpawnTime=Date.now()+1200,r()}function Pf(e,t){for(let n=0;n<30;n++)Y.particles.push({x:e+(Math.random()-.5)*40,y:t,vx:(Math.random()-.5)*7,vy:(Math.random()-.5)*5-3,hue:280+Math.random()*80,life:26+Math.random()*18})}function Ff(e){wf();let t=e.getContext(`2d`);t.fillStyle=`rgba(0, 0, 0, 0.75)`,t.fillRect(0,0,e.width,e.height),t.fillStyle=`#ff00ff`,t.font=`bold 52px "Courier New"`,t.textAlign=`center`,t.fillText(`GAME OVER`,e.width/2,150),t.fillStyle=`#ffff00`,t.font=`26px "Courier New"`,t.fillText(`FINAL SCORE: ${Math.floor(Y.score)}`,e.width/2,210),t.fillStyle=`#00ffff`,t.font=`20px "Courier New"`,t.fillText(`Press ESC to Exit   |   R to Restart`,e.width/2,280),e.onclick=()=>{e.onclick=null,Nf()}}function If(){if(J.isArcadeGameOpen=!0,vf||=jf(),vf.style.display===`flex`)return;vf.style.display=`flex`,Ef(`ag2`);let e=document.getElementById(`game-container`);e.innerHTML=`
    <canvas id="ag1-canvas" width="815" height="515" 
            style="display:block; background:#0a001f; border: 3px solid #00ffff;"></canvas>
    <div id="ag1-ui" style="position:absolute; top:10px; left:10px; color:#ffff00; font-family:monospace; font-size:18px;">
      SCORE: <span id="ag1-score">00000</span>
    </div>
  `,document.getElementById(`ag1-ui`).style.display=`none`;let t=vf.querySelector(`div[style*="color: #00ffff"]`);t&&(t.innerHTML=`🕹️ ARCADE MACHINE — AG2 閃避彈道`),Lf()}var X={};function Lf(){let e=document.getElementById(`ag1-canvas`),t=e.getContext(`2d`);X={angel:{x:380,y:240,width:46,height:46,speed:5.8},forks:[],score:0,gameSpeed:3.3,direction:`left`,lastDirectionChange:Date.now(),directionChangeInterval:5e3,spawnPausedUntil:0,isGameOver:!1,particles:[],animationFrameId:null,keys:{}},document.removeEventListener(`keydown`,n),document.removeEventListener(`keyup`,r),document.addEventListener(`keydown`,n),document.addEventListener(`keyup`,r);function n(e){X.keys[e.key.toLowerCase()]=!0,X.isGameOver&&e.key.toLowerCase()===`r`&&Lf(),e.key.toLowerCase()===`Escape`&&tp()}function r(e){X.keys[e.key.toLowerCase()]=!1}function i(){if(!e||X.isGameOver)return;t.clearRect(0,0,e.width,e.height),t.fillStyle=`#0a001f`,t.fillRect(0,0,e.width,e.height);let n=Date.now();if(n-X.lastDirectionChange>=X.directionChangeInterval){let t=[`left`,`right`,`up`,`down`];X.direction=t[Math.floor(Math.random()*t.length)],X.lastDirectionChange=n;try{let e=(J!==void 0&&J.currentBGMVolume?J.currentBGMVolume:.15)*2,t=new Audio(`./music/ag2_alert.mp3`);t.volume=e,t.play().catch(()=>{}),setTimeout(()=>{try{let t=new Audio(`./music/ag2_alert.mp3`);t.volume=e,t.play().catch(()=>{})}catch{}},250)}catch(e){console.error(`無法播放 ag2_alert 音效:`,e)}let r=7e3-X.score%100*100,i=Math.max(2e3,r),a=1500;X.directionChangeInterval=a+Math.random()*(i-a);let o=Math.max(20,200-Math.floor(X.score*.25));X.spawnPausedUntil=n+o,console.log(`%c[AG2] ⚠️ 警報！攻擊方向已切換為: ${X.direction.toUpperCase()} | 下次切換時間: ${(X.directionChangeInterval/1e3).toFixed(2)} 秒後`,`color:#ff00ff; font-weight:bold`),Rf(e.width/2,50)}t.fillStyle=`#1a0044`,t.fillRect(0,0,e.width,28),t.textAlign=`left`,t.fillStyle=`#00ffff`,t.font=`bold 14px "Courier New"`,t.fillText(`閃避遊戲 | DIR: ${X.direction.toUpperCase()} | ${Math.floor(X.score).toString().padStart(5,`0`)}`,18,19),X.score+=.018*X.gameSpeed;let r=X.angel,a=r.speed;if(X.keys.w&&(r.y-=a),X.keys.s&&(r.y+=a),X.keys.a&&(r.x-=a),X.keys.d&&(r.x+=a),r.x=Math.max(30,Math.min(e.width-80,r.x)),r.y=Math.max(40,Math.min(e.height-90,r.y)),n>X.spawnPausedUntil&&Math.random()<.032){let t=X.direction,n={};t===`left`?n={x:e.width+8,y:45+Math.random()*(e.height-120),width:32,height:13,vx:-X.gameSpeed}:t===`right`?n={x:-38,y:45+Math.random()*(e.height-120),width:32,height:13,vx:X.gameSpeed}:t===`up`?n={x:45+Math.random()*(e.width-120),y:e.height+8,width:13,height:32,vy:-X.gameSpeed}:t===`down`&&(n={x:45+Math.random()*(e.width-120),y:-32,width:13,height:32,vy:X.gameSpeed}),X.forks.push(n)}for(let n=X.forks.length-1;n>=0;n--){let i=X.forks[n];i.vx&&(i.x+=i.vx),i.vy&&(i.y+=i.vy),t.fillStyle=`#ff3366`,t.fillRect(i.x,i.y,i.width,i.height),r.x<i.x+i.width&&r.x+r.width>i.x&&r.y<i.y+i.height&&r.y+r.height>i.y&&(X.isGameOver=!0,zf(e)),(i.x<-55||i.x>e.width+55||i.y<-55||i.y>e.height+55)&&X.forks.splice(n,1)}t.fillStyle=`#aaffff`,t.fillRect(r.x,r.y,r.width,r.height),t.fillStyle=`#ffffff`,t.fillRect(r.x+11,r.y+9,9,9),t.fillRect(r.x+26,r.y+9,9,9),X.score>200&&(X.gameSpeed=3.9),X.score>450&&(X.gameSpeed=4.6),X.animationFrameId=requestAnimationFrame(i)}X.lastDirectionChange=Date.now(),i()}function Rf(e,t){for(let n=0;n<25;n++)X.particles.push({x:e+(Math.random()-.5)*30,y:t,vx:(Math.random()-.5)*6,vy:(Math.random()-.5)*5-2,life:20+Math.random()*15})}function zf(e){wf();let t=e.getContext(`2d`);t.fillStyle=`rgba(0, 0, 0, 0.8)`,t.fillRect(0,0,e.width,e.height),t.fillStyle=`#ff00ff`,t.font=`bold 48px "Courier New"`,t.textAlign=`center`,t.fillText(`GAME OVER`,e.width/2,140),t.fillStyle=`#ffff00`,t.font=`24px "Courier New"`,t.fillText(`FINAL SCORE: ${Math.floor(X.score)}`,e.width/2,200),t.fillStyle=`#00ffff`,t.font=`18px "Courier New"`,t.fillText(`Press R to Restart  |  ESC to Exit`,e.width/2,260),e.onclick=()=>{e.onclick=null,Lf()}}var Z={};function Bf(){if(J.isArcadeGameOpen=!0,vf||=jf(),vf.style.display===`flex`)return;vf.style.display=`flex`,Ef(`ag3`);let e=document.getElementById(`game-container`);e.innerHTML=`
    <canvas id="ag1-canvas" width="815" height="515" 
            style="display:block; background:#0a001f; border: 3px solid #ffff00;"></canvas>
    <div id="ag1-ui" style="position:absolute; top:10px; left:10px; color:#ffff00; font-family:monospace; font-size:16px;">
      BALANCE: <span id="ag3-balance">${J.ag3PersistentBalance}</span> &nbsp;&nbsp; WIN: <span id="ag3-win">0</span>
    </div>
  `;let t=vf.querySelector(`div[style*="color: #00ffff"]`);t&&(t.innerHTML=`🕹️ ARCADE MACHINE — AG3 老虎機(拉霸/角子機)`),Vf()}function Vf(){let e=document.getElementById(`ag1-canvas`),t=e.getContext(`2d`);Hf(),Z={reels:[[`7`,`🍒`,`🔔`,`💎`,`🍋`,`⭐`],[`7`,`🍒`,`🔔`,`💎`,`🍋`,`⭐`],[`7`,`🍒`,`🔔`,`💎`,`🍋`,`⭐`]],positions:[0,0,0],spinning:[!1,!1,!1],balance:J.ag3PersistentBalance,lastWin:0,isSpinning:!1,animationFrameId:null,particles:[]},document.removeEventListener(`keydown`,n),document.addEventListener(`keydown`,n),Z.keyHandler=n;function n(e){e.key===` `&&!Z.isSpinning&&J.isArcadeGameOpen&&(e.preventDefault(),r()),e.key.toLowerCase()===`escape`&&(J.ag3PersistentBalance=Z.balance,tp())}function r(){if(Z.balance<50){c(),setTimeout(()=>{J.ag3PersistentBalance=Z.balance,localStorage.setItem(`ag3Balance`,J.ag3PersistentBalance),tp()},1500);return}Z.balance-=50,J.ag3PersistentBalance=Z.balance,localStorage.setItem(`ag3Balance`,J.ag3PersistentBalance),Z.lastWin=0,Z.isSpinning=!0,a(),Z.spinning=[!0,!0,!0],Z.positions=[Math.random()*6,Math.random()*6,Math.random()*6],yf.push(setTimeout(()=>{J.isArcadeGameOpen&&(Z.spinning[0]=!1,Z.positions[0]=Math.round(Z.positions[0]))},900)),yf.push(setTimeout(()=>{J.isArcadeGameOpen&&(Z.spinning[1]=!1,Z.positions[1]=Math.round(Z.positions[1]))},1500)),yf.push(setTimeout(()=>{J.isArcadeGameOpen&&(Z.spinning[2]=!1,Z.isSpinning=!1,Z.positions[2]=Math.round(Z.positions[2]),i())},2100))}function i(){if(!J.isArcadeGameOpen)return;let e=Z.reels.map((e,t)=>e[Math.floor(Z.positions[t]+.5)%e.length]),t=0;e[0]===e[1]&&e[1]===e[2]&&(t=500),t>0&&(Z.balance+=t,J.ag3PersistentBalance=Z.balance,Z.lastWin=t,s(),typeof Tf==`function`&&Tf()),a()}function a(){let e=document.getElementById(`ag3-balance`),t=document.getElementById(`ag3-win`);e&&(e.innerText=Z.balance),t&&(t.innerText=Z.lastWin)}function o(){if(!J.isArcadeGameOpen||!e){Z.animationFrameId&&cancelAnimationFrame(Z.animationFrameId);return}t.fillStyle=`#0a001f`,t.fillRect(0,0,e.width,e.height),t.textAlign=`center`,t.fillStyle=`#ffff00`,t.font=`bold 22px "Courier New"`,t.fillText(`AG3 角子機`,e.width/2,45),t.font=`16px "Courier New"`,t.fillStyle=`#00ffff`,t.fillText(`按 SPACE 轉輪 | 每次 50 元`,e.width/2,70);let n=(e.width-480-40)/2;for(let e=0;e<3;e++){let r=n+e*180;t.fillStyle=`#0f002a`,t.fillRect(r,100,160,280),t.save(),t.beginPath(),t.rect(r+4,104,152,272),t.clip();let i=Z.reels[e],a=Z.positions[e];for(let e=-1;e<=2;e++){let n=i[(Math.floor(a)+e+i.length*10)%i.length],o=240+e*85-a%1*85;t.fillStyle=`#ffffff`,t.font=`bold 54px "Courier New"`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(n,r+160/2,o)}t.restore(),t.strokeStyle=`#ffff00`,t.lineWidth=6,t.strokeRect(r,100,160,280),Z.spinning[e]&&(Z.positions[e]+=.32)}if(Z.particles&&Z.particles.length>0)for(let e=Z.particles.length-1;e>=0;e--){let n=Z.particles[e];n.y+=n.vy,n.x+=n.vx,n.life--,t.fillStyle=`hsla(${Math.random()*360}, 100%, 70%, ${n.life/40})`,t.fillRect(n.x,n.y,8,8),n.life<=0&&Z.particles.splice(e,1)}t.textAlign=`center`,t.fillStyle=`#ff00ff`,t.font=`bold 18px "Courier New"`,t.fillText(`餘額: `+Z.balance+`   |   最近贏: `+Z.lastWin,e.width/2,440),Z.animationFrameId=requestAnimationFrame(o)}function s(){Z.particles=[];for(let t=0;t<60;t++)Z.particles.push({x:e.width/2+(Math.random()-.5)*300,y:80,vx:(Math.random()-.5)*6,vy:Math.random()*5+2,life:40+Math.random()*20})}function c(){let e=document.createElement(`div`);e.style.cssText=`
      position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);
      background: rgba(139, 0, 0, 0.9); color: #ffaaaa; padding: 20px 40px;
      font-size: 24px; font-family: "Courier New"; border: 3px solid #ff5555;
      border-radius: 10px; z-index: 999; text-align: center;
    `,e.innerHTML=`餘額不足！<br>即將關閉...<br><span style="font-size:16px"></span>`,document.getElementById(`game-container`).appendChild(e)}let l=document.getElementById(`close-arcade`);if(l){let e=l.onclick;l.onclick=function(){J.ag3PersistentBalance=Z.balance,localStorage.setItem(`ag3Balance`,J.ag3PersistentBalance),document.removeEventListener(`keydown`,n),Hf(),e&&e()}}Z.animationFrameId=requestAnimationFrame(o),a()}function Hf(){yf.forEach(e=>clearTimeout(e)),yf=[]}function Uf(){if(J.isArcadeGameOpen=!0,vf||=jf(),vf.style.display===`flex`)return;vf.style.display=`flex`,Ef(`ag4`);let e=document.getElementById(`game-container`);e.innerHTML=`
    <canvas id="ag1-canvas" width="815" height="515" 
            style="display:block; background:#0a001f; border: 3px solid #00ffff;"></canvas>
    <div id="ag1-ui" style="position:absolute; top:10px; left:10px; color:#ffff00; font-family:monospace; font-size:18px;">
      SCORE: <span id="ag4-score">00000</span> &nbsp;&nbsp; HITS: <span id="ag4-hits">0</span>
    </div>
  `;let t=vf.querySelector(`div[style*="color: #00ffff"]`);t&&(t.innerHTML=`🕹️ ARCADE MACHINE — AG4 TONTIE`),Gf()}var Wf={};function Gf(){let e=document.getElementById(`ag1-canvas`),t=e.getContext(`2d`);Wf={moles:Array(9).fill(null),score:0,hits:0,gameSpeed:1,isGameOver:!1,animationFrameId:null,particles:[],lastSpawn:0,spawnInterval:650},document.removeEventListener(`keydown`,n),document.addEventListener(`keydown`,n);function n(e){if(Wf.isGameOver){e.key.toLowerCase()===`r`&&Gf();return}let t=e.key,n=-1;t>=`1`&&t<=`9`&&(n=parseInt(t)-1),(t===`Numpad1`||t===`Numpad2`||t===`Numpad3`||t===`Numpad4`||t===`Numpad5`||t===`Numpad6`||t===`Numpad7`||t===`Numpad8`||t===`Numpad9`)&&(n=parseInt(t.slice(-1))-1),n>=0&&n<=8&&r(n),e.key.toLowerCase()===`Escape`&&tp()}function r(e){let t=Wf.moles[e];t&&t.active?(Wf.score+=10,Wf.hits++,t.active=!1,t.hitTime=Date.now(),o(t.x+t.size/2,t.y+t.size/2),document.getElementById(`ag4-score`).innerText=Wf.score.toString().padStart(5,`0`),document.getElementById(`ag4-hits`).innerText=Wf.hits):(Wf.score=Math.max(0,Wf.score-5),document.getElementById(`ag4-score`).innerText=Wf.score.toString().padStart(5,`0`))}function i(){let t=Date.now();if(t-Wf.lastSpawn<Wf.spawnInterval)return;let n=[];for(let e=0;e<9;e++)(!Wf.moles[e]||!Wf.moles[e].active)&&n.push(e);if(n.length===0)return;let r=n[Math.floor(Math.random()*n.length)],i=r%3,a=Math.floor(r/3),o=(e.width-330-60)/2;Wf.moles[r]={x:o+i*130,y:110+a*130,size:110,active:!0,spawnTime:t,life:1200+Math.random()*600},Wf.lastSpawn=t,Wf.score>150&&(Wf.spawnInterval=480),Wf.score>350&&(Wf.spawnInterval=380),Wf.score>600&&(Wf.spawnInterval=300)}function a(){if(!e||Wf.isGameOver)return;t.fillStyle=`#0a001f`,t.fillRect(0,0,e.width,e.height),t.fillStyle=`#ffff00`,t.font=`bold 24px "Courier New"`,t.textAlign=`center`,t.fillText(`AG4 TONTIE — 鍵盤 1~9 打地鼠`,e.width/2,45),t.font=`14px "Courier New"`,t.fillStyle=`#00ffff`,t.fillText(`按 1~9 對應位置打擊 | 打中 +10 | 打空 -5`,e.width/2,70);let n=Date.now();i();for(let r=0;r<9;r++){let i=Wf.moles[r];if(!i)continue;let a=r%3,o=Math.floor(r/3),s=(e.width-330-60)/2+a*130,c=110+o*130;t.fillStyle=`#220033`,t.beginPath(),t.arc(s+110/2,c+110/2+10,110/2-8,0,Math.PI*2),t.fill(),i.active?(t.fillStyle=`#ffaa00`,t.beginPath(),t.arc(s+110/2,c+110/2,110/2-12,0,Math.PI*2),t.fill(),t.fillStyle=`#ffffff`,t.beginPath(),t.arc(s+110/2-18,c+110/2-12,8,0,Math.PI*2),t.arc(s+110/2+18,c+110/2-12,8,0,Math.PI*2),t.fill(),t.fillStyle=`#000000`,t.beginPath(),t.arc(s+110/2-18,c+110/2-12,4,0,Math.PI*2),t.arc(s+110/2+18,c+110/2-12,4,0,Math.PI*2),t.fill(),t.fillStyle=`#ffffff`,t.font=`bold 28px "Courier New"`,t.textAlign=`center`,t.fillText((r+1).toString(),s+110/2,c+110/2+35),n-i.spawnTime>i.life&&(i.active=!1)):(t.fillStyle=`#111111`,t.beginPath(),t.arc(s+110/2,c+110/2+10,110/2-15,0,Math.PI*2),t.fill())}for(let e=Wf.particles.length-1;e>=0;e--){let n=Wf.particles[e];n.x+=n.vx,n.y+=n.vy,n.life--,t.fillStyle=`hsla(60, 100%, 80%, ${n.life/25})`,t.fillRect(n.x,n.y,6,6),n.life<=0&&Wf.particles.splice(e,1)}Wf.animationFrameId=requestAnimationFrame(a)}function o(e,t){for(let n=0;n<18;n++)Wf.particles.push({x:e,y:t,vx:(Math.random()-.5)*7,vy:(Math.random()-.5)*7-1,life:22+Math.random()*12})}Wf.lastSpawn=Date.now(),a()}var Q={currentSubGame:1,canvas:null,ctx:null,isWon:!1,statusText:`TASK: INCOMPLETE`,statusColor:`#00ffff`,animationFrameId:null,draggedItem:null,game1:{correctOrder:[`白橙`,`橙`,`白綠`,`藍`,`白藍`,`綠`,`白棕`,`棕`],nodes:[],slots:[]},game2:{cables:[],switches:[{id:`SW-A`,x:500,y:150,w:220,h:60,label:`Core Switch (SW-A)`},{id:`SW-B`,x:500,y:320,w:220,h:60,label:`Access Switch (SW-B)`}]},game3:{targetFrequency:3,currentFrequency:1,sliderX:200}};function Kf(){if(J.isArcadeGameOpen=!0,vf||=jf(),vf.style.display===`flex`)return;vf.style.display=`flex`,Ef(`ag3`);let e=vf.querySelector(`div[style*="color: #00ffff"]`);e&&(e.innerHTML=`🕹️ NETWORK INFRASTRUCTURE — AG5`);let t=document.getElementById(`game-container`);t.innerHTML=`
    <canvas id="ag5-canvas" width="815" height="420" 
            style="display:block; background:#050015; border: 3px solid #ffff00; box-shadow: 0 0 20px #ffff00;"></canvas>
    <div id="ag5-ui" style="position:absolute; top:15px; left:20px; color:#ffff00; font-family:'Courier New', monospace; font-size:16px; pointer-events:none;">
      [SYSTEM STATUS]: <span id="ag5-status" style="color:#00ffff; font-weight:bold; text-shadow:0 0 10px #00ffff;">INITIALIZING...</span>
    </div>
  `,qf(Math.floor(Math.random()*3)+1);let n=document.getElementById(`ag5-canvas`);n.addEventListener(`mousedown`,Zf),n.addEventListener(`mousemove`,Qf),window.addEventListener(`mouseup`,$f),ep()}function qf(e){Q.animationFrameId&&cancelAnimationFrame(Q.animationFrameId),Q.canvas=document.getElementById(`ag5-canvas`),Q.ctx=Q.canvas.getContext(`2d`),Q.currentSubGame=e,Q.isWon=!1,Q.draggedItem=null,Q.statusText=`TASK ${e}: INCOMPLETE (HOLD & DRAG)`,Q.statusColor=`#00ffff`,Jf();let t={白橙:`#ffebdf`,橙:`#ff6600`,白綠:`#dfdfeb`,藍:`#0066ff`,白藍:`#dfffeb`,綠:`#00cc44`,白棕:`#ebdff0`,棕:`#8b4513`};if(e===1){let e=[...Q.game1.correctOrder].sort(()=>Math.random()-.5);Q.game1.nodes=e.map((e,n)=>({name:e,color:t[e],startX:120,startY:60+n*42,x:120,y:60+n*42,radius:14,connectedSlot:null})),Q.game1.slots=Q.game1.correctOrder.map((e,t)=>({index:t,expectedName:e,x:650,y:60+t*42,width:100,height:30,filledBy:null}))}else e===2?Q.game2.cables=[{id:1,label:`To: Core Switch (SW-A)`,target:`SW-A`,color:`#00ffff`,x:150,y:160,startX:150,startY:160,radius:18,attachedTo:null},{id:2,label:`To: Access Switch (SW-B)`,target:`SW-B`,color:`#ff00ff`,x:150,y:300,startX:150,startY:300,radius:18,attachedTo:null}].sort(()=>Math.random()-.5):e===3&&(Q.game3.targetFrequency=Math.floor(Math.random()*4)+2,Q.game3.currentFrequency=1,Q.game3.sliderX=200)}function Jf(){let e=document.getElementById(`ag5-status`);e&&(e.innerText=Q.statusText,e.style.color=Q.statusColor,e.style.textShadow=`0 0 10px ${Q.statusColor}`)}function Yf(){Q.isWon=!0,Q.statusText=`▼ SUCCESS: NETWORK LINK ESTABLISHED!`,Q.statusColor=`#00ff88`,Jf(),J.isArcadeGameOpen!=0&&Tf(),setTimeout(()=>{J.isArcadeGameOpen&&Q.isWon&&tp()},2e3)}function Xf(){Q.statusText=`✕ ERROR: MISWIRING DETECTED! RESETTING...`,Q.statusColor=`#ff0055`,Jf(),typeof wf==`function`&&J.isArcadeGameOpen&&wf(),Q.draggedItem=null,Q.currentSubGame===1?(Q.game1.nodes.forEach(e=>{e.x=e.startX,e.y=e.startY,e.connectedSlot=null}),Q.game1.slots.forEach(e=>{e.filledBy=null})):Q.currentSubGame===2?Q.game2.cables.forEach(e=>{e.x=e.startX,e.y=e.startY,e.attachedTo=null}):Q.currentSubGame===3&&(Q.game3.sliderX=200,Q.game3.currentFrequency=1),setTimeout(()=>{J.isArcadeGameOpen&&!Q.isWon&&(Q.statusText=`TASK ${Q.currentSubGame}: INCOMPLETE (HOLD & DRAG)`,Q.statusColor=`#00ffff`,Jf())},600)}function Zf(e){if(Q.isWon)return;let t=Q.canvas.getBoundingClientRect(),n=e.clientX-t.left,r=e.clientY-t.top;if(Q.currentSubGame===1){for(let e of Q.game1.nodes)if(Math.hypot(e.x-n,e.y-r)<e.radius+5){Q.draggedItem={type:`node`,data:e},e.connectedSlot&&=(e.connectedSlot.filledBy=null,null);break}}else if(Q.currentSubGame===2){for(let e of Q.game2.cables)if(Math.hypot(e.x-n,e.y-r)<e.radius+5){Q.draggedItem={type:`cable`,data:e},e.attachedTo=null;break}}else Q.currentSubGame===3&&n>=Q.game3.sliderX-20&&n<=Q.game3.sliderX+20&&r>=340&&r<=390&&(Q.draggedItem={type:`slider`})}function Qf(e){if(!Q.draggedItem||Q.isWon)return;let t=Q.canvas.getBoundingClientRect(),n=e.clientX-t.left,r=e.clientY-t.top;Q.draggedItem.type===`node`||Q.draggedItem.type===`cable`?(Q.draggedItem.data.x=n,Q.draggedItem.data.y=r):Q.draggedItem.type===`slider`&&(Q.game3.sliderX=Math.max(200,Math.min(600,n)),Q.game3.currentFrequency=1+(Q.game3.sliderX-200)/400*5)}function $f(e){if(!Q.draggedItem||Q.isWon){Q.draggedItem=null;return}if(Q.currentSubGame===1){let e=Q.draggedItem.data,t=!1;for(let n of Q.game1.slots)if(!n.filledBy&&e.x>n.x&&e.x<n.x+n.width&&e.y>n.y&&e.y<n.y+n.height){if(e.x=n.x+15,e.y=n.y+n.height/2,e.connectedSlot=n,n.filledBy=e,t=!0,e.name!==n.expectedName){Q.draggedItem=null,Xf();return}break}t||(e.x=e.startX,e.y=e.startY),Q.game1.slots.every(e=>e.filledBy&&e.filledBy.name===e.expectedName)&&Yf()}else if(Q.currentSubGame===2){let e=Q.draggedItem.data,t=!1;for(let n of Q.game2.switches)if(e.x>n.x&&e.x<n.x+n.w&&e.y>n.y&&e.y<n.y+n.h){if(t=!0,e.target===n.id)e.x=n.x+30,e.y=n.y+n.h/2,e.attachedTo=n.id;else{Q.draggedItem=null,Xf();return}break}t||(e.x=e.startX,e.y=e.startY),Q.game2.cables.every(e=>e.attachedTo!==null)&&Yf()}else if(Q.currentSubGame===3)if(Math.abs(Q.game3.currentFrequency-Q.game3.targetFrequency)<.2)Yf();else{Q.draggedItem=null,Xf();return}Q.draggedItem=null}function ep(){if(!J.isArcadeGameOpen)return;let e=Q.ctx,t=Q.canvas;if(!(!e||!t)){e.fillStyle=`#060018`,e.fillRect(0,0,t.width,t.height),e.strokeStyle=`rgba(255, 0, 255, 0.05)`,e.lineWidth=1;for(let n=0;n<t.width;n+=40)e.beginPath(),e.moveTo(n,0),e.lineTo(n,t.height),e.stroke();for(let n=0;n<t.height;n+=40)e.beginPath(),e.moveTo(0,n),e.lineTo(t.width,n),e.stroke();if(Q.currentSubGame===1)e.fillStyle=`#ffffff`,e.font=`bold 15px monospace`,e.fillText(`▼ [TASK 1] ALIGN CAT5E TO T568B COLOR SCHEME`,50,35),Q.game1.slots.forEach(t=>{e.strokeStyle=`#ff00ff`,e.lineWidth=2,e.fillStyle=`rgba(255, 0, 255, 0.1)`,e.fillRect(t.x,t.y,t.width,t.height),e.strokeRect(t.x,t.y,t.width,t.height),e.fillStyle=`#00ffff`,e.font=`12px monospace`,e.fillText(`${t.index+1}.${t.expectedName}`,t.x+t.width+10,t.y+20)}),Q.game1.nodes.forEach(t=>{e.beginPath(),e.strokeStyle=t.color,e.lineWidth=4,e.moveTo(t.startX,t.startY),e.lineTo(t.x,t.y),e.stroke(),e.beginPath(),e.fillStyle=`#333`,e.arc(t.startX,t.startY,6,0,Math.PI*2),e.fill(),e.beginPath(),e.fillStyle=t.color,e.shadowBlur=10,e.shadowColor=t.color,e.arc(t.x,t.y,t.radius,0,Math.PI*2),e.fill(),e.shadowBlur=0,e.fillStyle=`#000`,e.font=`10px Arial`,e.textAlign=`center`,e.fillText(t.name,t.x,t.y+4),e.textAlign=`left`});else if(Q.currentSubGame===2)e.fillStyle=`#ffffff`,e.font=`bold 15px monospace`,e.fillText(`▼ [TASK 2] CONNECT LABELED CABLES TO CORRECT PATCH SWITCHES`,50,35),Q.game2.switches.forEach(t=>{e.fillStyle=`#222`,e.strokeStyle=`#ffff00`,e.lineWidth=3,e.fillRect(t.x,t.y,t.w,t.h),e.strokeRect(t.x,t.y,t.w,t.h);for(let n=0;n<8;n++)e.beginPath(),e.fillStyle=Math.random()>.3?`#00ff88`:`#005522`,e.arc(t.x+20+n*15,t.y+15,4,0,Math.PI*2),e.fill();e.fillStyle=`#ffff00`,e.font=`13px monospace`,e.fillText(t.label,t.x+15,t.y+45)}),Q.game2.cables.forEach(t=>{e.beginPath(),e.strokeStyle=t.color,e.lineWidth=5,e.moveTo(t.startX,t.startY),e.lineTo(t.x,t.y),e.stroke(),e.beginPath(),e.fillStyle=t.color,e.shadowBlur=12,e.shadowColor=t.color,e.arc(t.x,t.y,t.radius,0,Math.PI*2),e.fill(),e.shadowBlur=0,e.fillStyle=`#fff`,e.font=`11px monospace`,e.fillText(t.label,t.startX+25,t.startY-10)});else if(Q.currentSubGame===3){e.fillStyle=`#ffffff`,e.font=`bold 15px monospace`,e.fillText(`▼ [TASK 3] CALIBRATE SIGNAL FREQUENCY TO MATCH NETWORK`,50,35),e.beginPath(),e.strokeStyle=`rgba(0, 255, 136, 0.4)`,e.lineWidth=2;for(let t=150;t<650;t++){let n=180+Math.sin(t/50*Q.game3.targetFrequency)*50;t===150?e.moveTo(t,n):e.lineTo(t,n)}e.stroke(),e.beginPath(),e.strokeStyle=`#00ffff`,e.lineWidth=3,e.shadowBlur=8,e.shadowColor=`#00ffff`;for(let t=150;t<650;t++){let n=180+Math.sin(t/50*Q.game3.currentFrequency)*50;t===150?e.moveTo(t,n):e.lineTo(t,n)}e.stroke(),e.shadowBlur=0,e.fillStyle=`#333`,e.fillRect(200,360,400,10),e.fillStyle=`#ff00ff`,e.fillRect(Q.game3.sliderX-15,350,30,30),e.fillStyle=`#fff`,e.font=`14px monospace`,e.fillText(`Target: ${Q.game3.targetFrequency.toFixed(1)} GHz`,200,320),e.fillText(`Current: ${Q.game3.currentFrequency.toFixed(1)} GHz`,450,320)}Q.animationFrameId=requestAnimationFrame(ep)}}function tp(){J.isArcadeGameOpen=!1,vf&&(vf.style.display=`none`),Z&&Z.keyHandler&&(document.removeEventListener(`keydown`,Z.keyHandler),Z.keyHandler=null),Y&&Y.animationFrameId&&cancelAnimationFrame(Y.animationFrameId),X&&X.animationFrameId&&cancelAnimationFrame(X.animationFrameId),Z&&Z.animationFrameId&&cancelAnimationFrame(Z.animationFrameId),Wf&&Wf.animationFrameId&&cancelAnimationFrame(Wf.animationFrameId),Df()}var np={ag1:Mf,ag2:If,ag3:Bf,ag4:Uf,ag5:Kf};function rp(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function ip(e){let t=new Map,n=new Map,r=e.clone();return ap(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function ap(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)ap(e.children[r],t.children[r],n)}var op=class extends As{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new fp(e)}),this.register(function(e){return new pp(e)}),this.register(function(e){return new Sp(e)}),this.register(function(e){return new Cp(e)}),this.register(function(e){return new wp(e)}),this.register(function(e){return new hp(e)}),this.register(function(e){return new gp(e)}),this.register(function(e){return new _p(e)}),this.register(function(e){return new vp(e)}),this.register(function(e){return new dp(e)}),this.register(function(e){return new yp(e)}),this.register(function(e){return new mp(e)}),this.register(function(e){return new xp(e)}),this.register(function(e){return new bp(e)}),this.register(function(e){return new lp(e)}),this.register(function(e){return new Tp(e,$.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new Tp(e,$.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new Ep(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=ic.extractUrlBase(e);a=ic.resolveURL(t,this.path)}else a=ic.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new Ns(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===Dp){try{a[$.KHR_BINARY_GLTF]=new Ap(e)}catch(e){r&&r(e);return}i=JSON.parse(a[$.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new nm(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case $.KHR_MATERIALS_UNLIT:a[t]=new up;break;case $.KHR_DRACO_MESH_COMPRESSION:a[t]=new jp(i,this.dracoLoader);break;case $.KHR_TEXTURE_TRANSFORM:a[t]=new Mp;break;case $.KHR_MESH_QUANTIZATION:a[t]=new Np;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function sp(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function cp(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var $={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},lp=class{constructor(e){this.parser=e,this.name=$.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new G(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],We);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new nc(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new $s(s),o.distance=c;break;case`spot`:o=new Zs(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),Jp(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},up=class{constructor(){this.name=$.KHR_MATERIALS_UNLIT}getMaterialType(){return li}extendParams(e,t,n){let r=[];e.color=new G(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],We),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,Ue))}return Promise.all(r)}},dp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},fp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new B(e,e)}return Promise.all(r)}},pp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_DISPERSION}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},mp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},hp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SHEEN}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new G(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],We)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,Ue)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},gp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},_p=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_VOLUME}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new G().setRGB(i[0],i[1],i[2],We),Promise.all(r)}},vp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IOR}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},yp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SPECULAR}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new G().setRGB(i[0],i[1],i[2],We),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,Ue)),Promise.all(r)}},bp=class{constructor(e){this.parser=e,this.name=$.EXT_MATERIALS_BUMP}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},xp=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return cp(this.parser,e,this.name)===null?null:is}extendMaterialParams(e,t){let n=cp(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},Sp=class{constructor(e){this.parser=e,this.name=$.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Cp=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},wp=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Tp=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},Ep=class{constructor(e){this.name=$.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==Lp.TRIANGLES&&e.mode!==Lp.TRIANGLE_STRIP&&e.mode!==Lp.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new W,n=new V,a=new Pt,s=new V(1,1,1),c=new qi(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new zi(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);kn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},Dp=`glTF`,Op=12,kp={JSON:1313821514,BIN:5130562},Ap=class{constructor(e){this.name=$.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Op),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Dp)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Op,i=new DataView(e,Op),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===kp.JSON){let r=new Uint8Array(e,Op+a,t);this.content=n.decode(r)}else if(r===kp.BIN){let n=Op+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},jp=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=$.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=Hp[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=Hp[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=Rp[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,We,n)})})}},Mp=class{constructor(){this.name=$.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Np=class{constructor(){this.name=$.KHR_MESH_QUANTIZATION}},Pp=class extends ds{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},Fp=new Pt,Ip=class extends Pp{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return Fp.fromArray(i).normalize().toArray(i),i}},Lp={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},Rp={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},zp={9728:o,9729:l,9984:s,9985:u,9986:c,9987:d},Bp={33071:i,33648:a,10497:r},Vp={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Hp={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},Up={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},Wp={CUBICSPLINE:void 0,LINEAR:F,STEP:Ie},Gp={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function Kp(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new rs({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function qp(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function Jp(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function Yp(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function Xp(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function Zp(e){let t,n=e.extensions&&e.extensions[$.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+Qp(n.attributes):e.indices+`:`+Qp(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+Qp(e.targets[n]);return t}function Qp(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function $p(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function em(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var tm=new W,nm=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new sp,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new Is(this.options.manager):this.textureLoader=new oc(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Ns(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return qp(i,a,r),Jp(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+ e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[$.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(ic.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=Vp[r.type],t=Rp[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new vr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=Vp[r.type],o=Rp[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Pr(f,u/s),t.cache.add(n,c)),p=new Ir(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new vr(f,a,d);if(r.sparse!==void 0){let t=Vp.SCALAR,n=Rp[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new vr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=zp[n.magFilter]||1006,t.minFilter=zp[n.minFilter]||1008,t.wrapS=Bp[n.wrapS]||1e3,t.wrapT=Bp[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new Xt(e);t.needsUpdate=!0,n(t)}),t.load(ic.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),Jp(e,a),e.userData.mimeType=a.mimeType||em(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[$.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[$.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[$.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new ga,Rr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new na,Rr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return rs}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[$.KHR_MATERIALS_UNLIT]){let e=r[$.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new G(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],We),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,Ue)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||Gp.OPAQUE;if(l===Gp.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===Gp.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==li&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new B(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==li&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==li){let e=i.emissiveFactor;o.emissive=new G().setRGB(e[0],e[1],e[2],We)}return i.emissiveTexture!==void 0&&a!==li&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,Ue)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),Jp(n,i),t.associations.set(n,{materials:e}),i.extensions&&qp(r,n,i),n})}createUniqueName(e){let t=Sc.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[$.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return im(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=Zp(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[$.KHR_DRACO_MESH_COMPRESSION]?i(o):im(new Nr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?Kp(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===Lp.TRIANGLES||u.mode===Lp.TRIANGLE_STRIP||u.mode===Lp.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new Ni(l,f):new xi(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===Lp.TRIANGLE_STRIP?d.geometry=rp(d.geometry,1):u.mode===Lp.TRIANGLE_FAN&&(d.geometry=rp(d.geometry,2));else if(u.mode===Lp.LINES)d=new ma(l,f);else if(u.mode===Lp.LINE_STRIP)d=new ua(l,f);else if(u.mode===Lp.LINE_LOOP)d=new ha(l,f);else if(u.mode===Lp.POINTS)d=new xa(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&Xp(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),Jp(d,i),u.extensions&&qp(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&qp(r,c[0],i),c[0];let l=new An;i.extensions&&qp(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new Ys(Nt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new ec(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Jp(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new W;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new Ri(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new ws(i,void 0,l);return Jp(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,tm)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new V().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new Pi:t.length>1?new An:t.length===1?t[0]:new kn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),Jp(o,i),i.extensions&&qp(n,o,i),i.matrix!==void 0){let e=new W;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new An;n.name&&(i.name=r.createUniqueName(n.name)),Jp(i,n),n.extensions&&qp(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(ip(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Rr||e instanceof Xt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}Up[i.path]===Up.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(Up[i.path]){case Up.weights:l=ys;break;case Up.rotation:l=xs;break;case Up.translation:case Up.scale:l=Cs;break;default:switch(n.itemSize){case 1:l=ys;break;default:l=Cs;break}break}let u=r.interpolation===void 0?F:Wp[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+Up[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=$p(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof xs?Ip:Pp)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function rm(e,t,n){let r=t.attributes,i=new er;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new V(t[0],t[1],t[2]),new V(a[0],a[1],a[2])),e.normalized){let t=$p(Rp[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new V,t=new V;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=$p(Rp[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Tr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function im(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=Hp[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return U.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${U.workingColorSpace}" not supported.`),Jp(e,t),rm(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:Yp(e,t.targets,n)})}var am=new op;function om(e,t,n){am.load(e,n=>{let r=n.scene;console.log(`%c GLTF 模型載入成功: `+e,`color:#00ff88`),t&&t(r)},void 0,t=>{console.error(`%c GLTF 載入失敗: `+e,`color:#ff0000`,t),n&&n(t)})}var sm=[],cm,lm={},um=[],dm,fm,pm,mm,hm,gm=!1,_m=0,vm=`text`,ym,bm,xm=0,Sm=[],Cm=new Is;function wm(e,t){let n=new An;n.position.set(3,3,3),e.add(n),om(`./models/ice_cream_slime.glb`,e=>{e.scale.set(3,4,3),e.position.set(0,-.7,0),n.add(e),cm=n,console.log(`%c ice_cream_slime.glb 已載入`,`color:#00ff88`)}),[{pos:[-15,.1,-14],name:`arcade1`,game:`ag1`,scale:2.2,model:`./models/Arcade_Machine.glb`},{pos:[-15,.1,-8],name:`arcade2`,game:`ag2`,scale:2.2,model:`./models/Arcade_Machine.glb`},{pos:[-15,.1,16],name:`arcade3`,game:`ag3`,scale:20.2,model:`./models/slot_machine.glb`},{pos:[11,3.1,-12],name:`arcade4`,game:`ag4`,scale:1.5,model:`./models/ag4.glb`},{pos:[-15,.1,5],name:`arcade5`,game:`ag5`,scale:.05,model:`./models/red_cable_4.glb`,rotY:.5+Math.PI/2}].forEach((n,r)=>{let i=new An;i.position.set(...n.pos),i.userData={name:n.name,game:n.game},e.add(i),t.push(i),om(n.model,e=>{e.scale.set(n.scale,n.scale,n.scale),e.position.set(0,0,0),n.rotY!==void 0&&(e.rotation.y=n.rotY),i.add(e),console.log(`%c Arcade Machine ${r+1} 已載入`,`color:#00ff88`)})});let r=new An;r.position.set(-14,4,0),r.userData={name:`computer`},e.add(r),t.push(r),om(`./models/pc.glb`,e=>{e.scale.set(10,10,5),e.position.set(0,-2,0),e.rotation.y=-Math.PI/2,r.add(e)});let i=new An,a=new rs({color:4460851,emissive:11141375,emissiveIntensity:1.3}),o=new xi(new Oa(2,3.8,.3),a);o.position.set(0,1.8,-.6),i.add(o);let s=new xi(new Oa(.2,3.8,1.2),a);s.position.set(-.9,1.8,0),i.add(s);let c=s.clone();c.position.x=.9,i.add(c);for(let e=0;e<5;e++){let t=new xi(new Oa(1.8,.12,1),a);t.position.y=e*.75,i.add(t)}let l=new rs({color:65535,emissive:65535,emissiveIntensity:1.2});for(let e=0;e<12;e++){let e=new xi(new Oa(.25,.6,.15),l);e.position.set((Math.random()-.5)*1.2,.3+Math.random()*3,-.2),e.rotation.y=(Math.random()-.5)*.6,i.add(e)}i.position.set(0,.1,14),i.userData={name:`bookshelf`},e.add(i),t.push(i),km(e),Am(e),Mm(e),Fm(e),ym=new An,ym.position.set(15,4,0),ym.rotation.y=-Math.PI/2,ym.userData={name:`tv`},e.add(ym),t.push(ym),bm=new xi(new Wo(3.2,1.8),new li({color:16777215,side:2,fog:!1,toneMapped:!1})),bm.scale.set(3,3,3),bm.position.set(0,-.5,-1.99),ym.add(bm),om(`./models/retro_crt_tv.glb`,e=>{e.scale.set(10,9.5,1.15),e.position.set(-25.5,6,-2),ym.add(e),e.traverse(e=>{if(e.isMesh){let t=e.name.toLowerCase();(t.includes(`screen`)||t.includes(`display`)||t.includes(`monitor`)||t.includes(`glass`))&&(e.visible=!1)}}),console.log(`%c GLTF 電視載入成功！`,`color:#00ff88`)}),Om();let u=new An;u.position.set(0,1.5,-14),u.userData={name:`gallery`},e.add(u),t.push(u),om(`./models/desk.glb`,e=>{e.scale.set(5,5,5),e.position.set(0,-1.5,3),e.rotation.y=Math.PI,u.add(e),om(`./models/office_chair.glb`,e=>{e.scale.set(5,5,5),e.position.set(.5,-1.5,-1),e.rotation.y=-.6,u.add(e)})});let d=new An;d.position.set(13,3.1,13),d.userData={name:`creditTable`},e.add(d),t.push(d),om(`./models/Light_Desk.glb`,e=>{e.scale.set(10.2,10.2,10.2),e.position.set(2,-3,2),e.rotation.y=Math.PI+Math.PI*.25,d.add(e),console.log(`%c creditTable 已載入`,`color:#00ff88`)}),Nm(r,e),Nm(i,e),Nm(ym,e),Nm(u,e),Nm(d,e)}function Tm(e,t=16/9){if(!e||!e.image||!e.image.width||!e.image.height)return;let n=e.image.width/e.image.height,r=1,a=1,o=0,s=0;n>t?(r=t/n,o=(1-r)/2):(a=n/t,s=(1-a)/2),e.repeat.set(r,a),e.offset.set(o,s),e.wrapS=i,e.wrapT=i,e.minFilter=l,e.magFilter=l,e.colorSpace=Ue,e.needsUpdate=!0}function Em(e){if(Sm.length===0||!bm||!bm.material)return;xm=(xm+e+Sm.length)%Sm.length;let t=Sm[xm];bm.material.map&&bm.material.map.dispose(),Tm(t),bm.material.map=t,bm.material.color.setHex(16777215),bm.material.fog=!1,bm.material.toneMapped=!1,bm.material.needsUpdate=!0}function Dm(){window.tvInterval&&clearInterval(window.tvInterval),window.tvInterval=setInterval(()=>Em(1),3e3)}async function Om(){console.log(`%c Func:電視輪播圖片...載入成功`,`color:#00ff88; font-size:16px`);for(let e of _f.tvImages)try{let t=await Cm.loadAsync(e);t.colorSpace=Ue,Tm(t),Sm.push(t),console.log(`%c 載入成功initTvCarousel()`,`color:#00ff88`)}catch{console.warn(`%c 載入失敗initTvCarousel(): `+e,`color:#ff00ff`)}if(Sm.length>0){if(bm&&bm.material){let e=Sm[0];Tm(e),bm.material.map=e,bm.material.needsUpdate=!0}xm=0,Dm()}}function km(e){let t=document.createElement(`canvas`);t.width=512,t.height=380;let n=t.getContext(`2d`);n.fillStyle=`rgba(20, 0, 45, 0.85)`,n.fillRect(0,0,t.width,t.height);function r(e,t,r){n.fillStyle=`#1a0033`,n.strokeStyle=`#00ffff`,n.lineWidth=18,n.shadowColor=`#00ffff`,n.shadowBlur=35,n.beginPath(),n.roundRect(e,t,110,110,18),n.fill(),n.stroke(),n.shadowBlur=25,n.fillStyle=`#ffffff`,n.font=`bold 82px "Courier New", monospace`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(r,e+55,t+62),n.shadowBlur=8,n.fillStyle=`#bbffff`,n.fillText(r,e+55,t+62)}r(200,20,`W`),r(90,150,`A`),r(200,150,`S`),r(310,150,`D`),n.shadowBlur=20,n.fillStyle=`#ff00ff`,n.font=`bold 32px "Courier New", monospace`,n.textAlign=`center`,n.fillText(`USE TO MOVE`,t.width/2,315);let i=new li({map:new wa(t),transparent:!0,side:2,depthWrite:!1,opacity:.95}),a=new xi(new Wo(3.8,2.9),i);a.position.set(0,.15,0),a.rotation.x=-Math.PI/2,e.add(a),console.log(`%c WASD教學已加入！`,`color:#00ff88; font-size:18px`)}function Am(e){lm.computer=jm(`CV`,`#ffff00`),lm.bookshelf=jm(`SAVE POINT`,`#00ffff`),lm.tv=jm(`IMAGES`,`#ff00ff`),lm.gallery=jm(`PROJECT GALLERY`,`#ffffff`),lm.creditTable=jm(`CREDITS`,`#ff00ff`),Object.values(lm).forEach(t=>e.add(t))}function jm(e,t=`#ffffff`){let n=document.createElement(`canvas`),r=n.getContext(`2d`);n.width=612,n.height=128,r.fillStyle=`rgba(0, 0, 0, 0.6)`,r.fillRect(0,0,n.width,n.height),r.font=`bold 60px "Courier New", monospace`,r.fillStyle=t,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(e,n.width/2,n.height/2);let i=new $r(new zr({map:new wa(n),transparent:!0,depthTest:!1}));return i.scale.set(4,1,1),i.visible=!1,i}function Mm(e){let t=[];function n(n,r,i,a=0){let o=document.createElement(`canvas`);o.width=1024,o.height=512;let s=o.getContext(`2d`);s.fillStyle=`rgba(17, 0, 34, 0.7)`,s.fillRect(0,0,o.width,o.height),s.shadowColor=`#00ffff`,s.shadowBlur=40,s.fillStyle=`#00ffff`,s.font=`bold 90px "Courier New", monospace`,s.textAlign=`center`,s.textBaseline=`middle`,s.fillText(n,o.width/2,o.height/2),s.shadowBlur=15,s.fillStyle=`#ffffff`,s.fillText(n,o.width/2,o.height/2);let c=new li({map:new wa(o),transparent:!0,side:2,depthWrite:!1,opacity:0}),l=new xi(new Wo(7,4),c);return l.position.set(r,.12,i),l.rotation.x=-Math.PI/2,l.rotation.z=a,e.add(l),t.push(l),l}n(`PROJECT GALLERY`,0,-8,0),n(`SAVE POINT`,0,8,Math.PI),n(`CV`,-8,0,Math.PI/2),n(`IMAGES`,8,0,-Math.PI/2),um=t,console.log(`%c 閃爍-位置提示 已加入`,`color:#ff00ff; font-size:18px`)}function Nm(e,t){if(!e)return;let n=new ao;n.moveTo(0,1.2),n.lineTo(.7,0),n.lineTo(0,-1.2),n.lineTo(-.7,0),n.lineTo(0,1.2);let r=new xi(new Go(n),new li({color:16777215,side:2,transparent:!0,opacity:.85,depthTest:!1}));r.position.copy(e.position),r.position.y+=4.5,r.userData.linkedObject=e,r.userData.name=e.userData.name,t.add(r),window.markers||(window.markers=[]),window.markers.push(r)}function Pm(){let e=hm;e.fillStyle=`#0a001f`,e.fillRect(0,0,512,256),e.shadowColor=`#00ffff`,e.shadowBlur=30,e.fillStyle=`#ffff00`,e.font=`bold 68px "Courier New"`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(`HELLO WORLD`,256,128,256),e.shadowBlur=55,e.fillStyle=`#ff00ff`,e.fillText(`HELLO WORLD`,256,128,256)}function Fm(e){fm=document.createElement(`canvas`),fm.width=256,fm.height=128,pm=fm.getContext(`2d`,{alpha:!0}),mm=document.createElement(`canvas`),mm.width=512,mm.height=256,hm=mm.getContext(`2d`,{alpha:!0}),Pm();let t=new wa(mm);t.colorSpace=Ue;let n=new li({map:t,side:2,transparent:!0,opacity:.95});dm=new xi(new Wo(7,3.5),n),dm.position.set(13,7.5,-6),dm.rotation.y=-.9,e.add(dm),console.log(`%c [新增] HELLO WORLD 雜訊螢幕已建立`,`color:#00ff88`)}function Im(){if(!pm)return;let e=fm.width,t=fm.height,n=pm.createImageData(e,t),r=n.data;for(let e=0;e<r.length;e+=4){let t=Math.random()*255|0;r[e]=r[e+1]=r[e+2]=t,r[e+3]=180+Math.random()*75}pm.putImageData(n,0,0),pm.strokeStyle=`rgba(255,255,255,0.25)`,pm.lineWidth=1.5;for(let n=3;n<t;n+=5)pm.beginPath(),pm.moveTo(0,n),pm.lineTo(e,n),pm.stroke()}function Lm(e=1400){if(!dm||gm)return;gm=!0,_m=Date.now()+e,vm=`noise`;let t=new wa(fm);t.colorSpace=Ue,dm.material.map=t,dm.material.needsUpdate=!0}function Rm(e){if(!dm||!e)return;let t=e.position.distanceTo(dm.position),n=Date.now();if((t>16||e.position.z<-8)&&!gm){Lm(900);return}if(t>17&&vm!==`noise`?(Lm(1100),setTimeout(()=>{if(dm&&vm===`noise`){let e=new wa(mm);e.colorSpace=Ue,dm.material.map=e,dm.material.needsUpdate=!0,vm=`text`,gm=!1}},1100)):t<8.5&&vm===`text`&&!gm&&(Lm(550),setTimeout(()=>{if(dm&&vm===`noise`){let e=new wa(mm);e.colorSpace=Ue,dm.material.map=e,dm.material.needsUpdate=!0,vm=`text`,gm=!1}},550)),gm&&n<_m)Im(),dm.material.map&&(dm.material.map.needsUpdate=!0);else if(gm&&n>=_m){let e=new wa(mm);e.colorSpace=Ue,dm.material.map=e,dm.material.needsUpdate=!0,gm=!1,vm=`text`}}var zm=[],Bm=0,Vm={},Hm=!1,Um=null,Wm=new wc,Gm=new B;window.markers=sm,new V(12.5,4.5,-2),new V(17,3,-2),new V(-16,3.5,-10),new V(-14,1,-10),new V(0,4.5,16),new V(0,1.5,14),new V(0,4,-16),new V(0,1.5,-14);var Km=new zn;Km.fog=new Rn(655391,12,45);var qm=new Ys(75,window.innerWidth/window.innerHeight,.1,100);qm.position.set(0,10,10);var Jm=new Kd({canvas:document.getElementById(`canvas`),antialias:!0});Jm.setSize(window.innerWidth,window.innerHeight),Jm.setPixelRatio(Math.min(window.devicePixelRatio,2)),Jm.shadowMap.enabled=!0;var Ym=new rc(6684842,.7);Km.add(Ym);var Xm=new nc(16711935,1.2);Xm.position.set(15,25,10),Km.add(Xm);var Zm=new $s(65535,2,60);Zm.position.set(-10,8,-10),Km.add(Zm);var Qm=new $s(16711935,1.8,60);Qm.position.set(10,8,10),Km.add(Qm);var $m=new xi(new Wo(35,35),new rs({color:2228275,emissive:16711850,emissiveIntensity:.6}));$m.rotation.x=-Math.PI/2,Km.add($m);var eh=new rs({color:1114146,emissive:4456618,emissiveIntensity:.5,side:2}),th=14;[-17.5,17.5].forEach(e=>{let t=new xi(new Wo(35,th),eh);t.position.z=e,Km.add(t)}),[-17.5,17.5].forEach(e=>{let t=new xi(new Wo(35,th),eh);t.rotation.y=Math.PI/2,t.position.x=e,Km.add(t)});function nh(){let e=new Nr,t=new Float32Array(800*3),n=new Float32Array(800*3),r=new Float32Array(800),i=[65535,16711935,16776960,65416];for(let e=0;e<800*3;e+=3){t[e]=(Math.random()-.5)*60,t[e+1]=Math.random()*18+1,t[e+2]=(Math.random()-.5)*60;let a=new G(i[Math.floor(Math.random()*i.length)]);n[e]=a.r,n[e+1]=a.g,n[e+2]=a.b,r[e/3]=Math.random()*.15+.05}e.setAttribute(`position`,new vr(t,3)),e.setAttribute(`color`,new vr(n,3)),e.setAttribute(`size`,new vr(r,1));let a=new xa(e,new ga({size:.12,vertexColors:!0,transparent:!0,opacity:.85,blending:2,depthTest:!1}));Km.add(a),a.userData={velocity:new Float32Array(800*3)};for(let e=0;e<800*3;e+=3)a.userData.velocity[e]=(Math.random()-.5)*.02,a.userData.velocity[e+1]=(Math.random()-.5)*.015,a.userData.velocity[e+2]=(Math.random()-.5)*.02;return a}var rh=nh();wm(Km,zm);var ih=null,ah=0;function oh(){hh.classList.remove(`active`),ph.classList.add(`active`)}function sh(e){if(!ih)return;let t=ih.detailImages||ih.images||[];t.length<=1||(ah=(ah+e+t.length)%t.length,ch())}function ch(){let e=document.getElementById(`project-detail-image`),t=document.getElementById(`project-image-counter`);if(!e||!ih)return;let n=ih.detailImages||ih.images||[];if(n.length===0){e.src=``,t&&(t.textContent=`0 / 0`);return}ah=Math.max(0,Math.min(ah,n.length-1)),e.src=n[ah]||``,t&&(t.textContent=`${ah+1} / ${n.length}`)}function lh(e){ih=_f.galleryProjects[e],ah=0,ph.classList.remove(`active`),hh.classList.add(`active`),document.getElementById(`project-detail-header`).innerHTML=`${ih.title} <span style="font-size:0.6em;color:#ffff00;">${ih.subtitle||``}</span>`,document.getElementById(`project-detail-info`).innerHTML=`<p style="margin:0;opacity:0.95;">${ih.desc}</p>`,ch();let t=document.getElementById(`project-link-btn`);ih.link&&ih.link.trim()!==``?(t.style.background=`#ff00ff`,t.style.cursor=`pointer`,t.innerHTML=`🔗 VIEW SOURCE / GITHUB`,t.onclick=()=>window.open(ih.link,`_blank`)):(t.style.background=`#444`,t.style.borderColor=`#666`,t.style.cursor=`not-allowed`,t.style.opacity=`0.6`,t.innerHTML=`🔒 SECRET / CONFIDENTIAL`,t.onclick=null)}window.openProjectDetail=lh,window.closeProjectDetail=oh,window.switchProjectImage=sh,Of();var uh=new rf(qm,Jm.domElement);uh.enableDamping=!0,uh.dampingFactor=.08,uh.target.set(0,1,0),window.addEventListener(`keydown`,e=>Vm[e.key.toLowerCase()]=!0),window.addEventListener(`keyup`,e=>Vm[e.key.toLowerCase()]=!1);var dh=document.getElementById(`cv-panel`),fh=document.getElementById(`skills-panel`),ph=document.getElementById(`gallery-panel`),mh=document.getElementById(`credits-panel`),hh=document.getElementById(`project-detail-panel`);document.getElementById(`close-cv`)&&document.getElementById(`close-cv`).addEventListener(`click`,()=>dh.classList.remove(`active`)),document.getElementById(`close-skills`)&&document.getElementById(`close-skills`).addEventListener(`click`,()=>fh.classList.remove(`active`)),document.getElementById(`close-gallery`)&&document.getElementById(`close-gallery`).addEventListener(`click`,()=>ph.classList.remove(`active`)),document.getElementById(`close-credits`)&&document.getElementById(`close-credits`).addEventListener(`click`,()=>mh.classList.remove(`active`)),document.getElementById(`close-project-detail`)&&document.getElementById(`close-project-detail`).addEventListener(`click`,oh);var gh=document.getElementById(`project-prev-btn`),_h=document.getElementById(`project-next-btn`);gh&&gh.addEventListener(`click`,e=>{e.stopPropagation(),sh(-1)}),_h&&_h.addEventListener(`click`,e=>{e.stopPropagation(),sh(1)});function vh(){dh&&dh.classList.remove(`active`),fh&&fh.classList.remove(`active`),ph&&ph.classList.remove(`active`),mh&&mh.classList.remove(`active`),hh&&hh.classList.remove(`active`)}function yh(e){if(e===`computer`)dh.classList.add(`active`),document.getElementById(`cv-content`).innerHTML=`
      ...
      ${_f.cv.projects}
    `;else if(e===`bookshelf`){fh&&fh.classList.add(`active`);let e=document.getElementById(`skills-content`),t=(e,t,n=`#00ffff`)=>`
      <div style="margin: 14px 0 18px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
          <span style="color:#00ffff; font-weight:bold; font-size:15px;">${e}</span>
          <span style="color:#ffff00; font-family:monospace; font-size:14px;">LV.${t}</span>
        </div>
        <div style="height:9px; background:#220033; border:1px solid #00ffff; border-radius:4px; overflow:hidden; box-shadow:0 0 8px #00ffff;">
          <div style="height:100%; width:${t}%; background:linear-gradient(90deg, ${n}, #ff00ff); box-shadow:0 0 12px ${n}; transition:width 0.4s ease;"></div>
        </div>
      </div>
    `;e.innerHTML=`
      <div style="text-align:center; margin-bottom:20px;">
        <div style="font-size:15px; color:#00ffff; margin:8px 0 5px;">YEUNG HANG // CLASS: COMPUTER SCIENCE // LV.26</div>
      </div>

      <div class="section-title" style="color:#ff00ff; text-align:center; margin-top:10px;">PROGRAMMING LANGUAGES</div>
      ${t(`Python`,38,`#00ffff`)}
      ${t(`Java / PHP`,49,`#ffff00`)}
      ...
      <div style="margin-top:25px; text-align:center; font-size:13px; color:#888;">
        ...
        <br>Gmail: yeungzero0@gmail.com || Git: https://github.com/yeungzero0
      </div>
    `}else if(e===`gallery`){ph.classList.add(`active`);let e=document.getElementById(`gallery-content`);e.innerHTML=_f.galleryProjects.map((e,t)=>`
      <div class="project-card" style="cursor: pointer;" onclick="openProjectDetail(${t})">
        <img src="${e.images?e.images[0]:``}" alt="${e.title}">
        <div class="info">
          <h3>${e.title}
          ${e.subtitle?`<div class="subtitle"><span style="font-size: 60%;">${e.subtitle}</div>`:``}</span></h3>
          <p>${e.desc}</p>
        </div>
      </div>
    `).join(``)}else if(e===`creditTable`){mh.classList.add(`active`);let e=document.getElementById(`credits-content`);e&&(e.innerHTML=`
        <div class="section-title">MUSIC / SOUND</div>
        <div style="line-height:1.6; font-size:15px;">
          • fireworks_se.mp3 — フリー効果音素材「発火」 by T.Waraya
          <br>• ag1_gameover.mp3 — フリー効果音素材「雑魚銃」 by 稿屋 隆
          <br>• ag1_jump.mp3 — フリー効果音素材「レトロアクション」 by 稿屋 隆
          <br>• ag1_main.mp3 — フリーBGM素材「Ghost In The Airwave」 by MFP【Marron Fields Production】
          <br>• ag2_main.mp3 — フリーBGM素材「時事の扉」 by まんぼう二等兵
          <br>• ag2_alert.mp3 — Correct Choice Sound Effect by freesound_community from Pixabay
          <br>• ag3_main.mp3 — フリーBGM素材「いつもどおりの穏やかな日常」 by じゅんいちろう
          <br>• main_bgm.mp3 — Aeon by Jeff Kaale (Uppbeat) [License: TV229H8RLR5LZWC9]
        </div>

        <div class="section-title" style="margin-top:20px;">3D MODELS</div>
        <div style="line-height:1.6; font-size:15px;">
          • pc.glb — CRT Monitor by Jarlan Perez [CC-BY] via Poly Pizza
          <br>• retro_crt_tv.glb — Tv by Zsky [CC-BY] via Poly Pizza 
          <br>• desk.glb — Desk by Quaternius
          <br>• office_chair.glb — Office Chair by Quaternius
          <br>• Light_Desk.glb — Light Desk by Quaternius
          <br>• Arcade_Machine.glb — Arcade Machine by J-Toastie [CC-BY] via Poly Pizza
          <br>• ag4.glb — INCUB'ARCADE V3.0 by L'INCUBATEUR Loritz'Labs [CC-BY] via Poly Pizza
          <br>• red_cable_4.glb — red cable 4 by Jeremy Eyring [CC-BY]  via Poly Pizza
          
          <br>• slot_machine.glb — Slot Machine by jacknelsonnsb on Sketchfab
          <br>• ice_cream_slime.glb — Ice Cream Slime by Empsy on Sketchfab
        </div>

        <div style="margin-top:25px; font-size:13px; color:#888;">
          Special thanks to all creators who shared their work for free!
        </div>

        <div style="margin-top:25px; font-size:13px; color:#888;">
          Developer By Yeung Hang (Me), 2026-05-18
        </div>
      `),document.getElementById(`credits-panel`).classList.add(`active`)}}function bh(){if(!cm)return;let e=null,t=null,n=1/0;zm.forEach(r=>{let i=cm.position.distanceTo(r.position);i<5&&i<n&&(n=i,e=r.userData.name,t=r)}),Um=e,Object.keys(lm).forEach(n=>{let r=lm[n];n===e&&t?(r.visible=!0,r.position.copy(t.position),r.position.y+=5.5):r.visible=!1})}window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(e.key===`Escape`){vh();return}if(hh&&hh.classList.contains(`active`)){if(t===`q`||e.key===`ArrowLeft`){e.preventDefault(),sh(-1);return}if(t===`e`||e.key===`ArrowRight`){e.preventDefault(),sh(1);return}}if(t===` `&&Um){e.preventDefault();let t=zm.find(e=>e.userData&&e.userData.name===Um);t&&t.userData.game&&np[t.userData.game]?(J.isArcadeGameOpen=!0,np[t.userData.game]()):yh(Um)}t===`q`?Em(-1):t===`e`?Em(1):t===`m`?kf():t===`-`||t===`_`?Af(-.1):(t===`=`||t===`+`)&&Af(.1)}),Jm.domElement.addEventListener(`click`,e=>{Gm.x=e.clientX/window.innerWidth*2-1,Gm.y=-(e.clientY/window.innerHeight)*2+1,Wm.setFromCamera(Gm,qm);let t=Wm.intersectObjects(sm,!0);if(t.length>0){let e=t[0].object.userData.name;e&&yh(e)}});var xh=.08,Sh=1,Ch=1,wh=1,Th=1,Eh=0;function Dh(){if(J.isArcadeGameOpen||cm===void 0||!cm)return;let e=new V;qm.getWorldDirection(e),e.y=0,e.normalize();let t=new V(-e.z,0,e.x).normalize(),n=0,r=0;if(Vm.w&&(n+=e.x,r+=e.z),Vm.s&&(n-=e.x,r-=e.z),Vm.a&&(n-=t.x,r-=t.z),Vm.d&&(n+=t.x,r+=t.z),n!==0||r!==0){let t=Math.hypot(n,r);n/=t,r/=t,cm.rotation.y=Math.atan2(n,r),cm.position.x+=n*xh,cm.position.z+=r*xh;let i=Date.now()*.001;Eh=Nt.lerp(Eh,1,.1);let a=Math.sin(i*7.2)*.14*Eh;cm.position.x+=e.x*a*.35,cm.position.z+=e.z*a*.35,Th=1;let o=Math.sin(i*8.5)*.13;Sh=1*(1+o*.28),Ch=1*(1+o*.2),wh=1*(1-o*.55),Hm=!0}else{Eh=Nt.lerp(Eh,0,.15);let t=Date.now()*.001,n=Math.sin(t*7.2)*.14*Eh;cm.position.x+=e.x*n*.35,cm.position.z+=e.z*n*.35,Th=.8,Sh=Nt.lerp(Sh,1,.2),Ch=Nt.lerp(Ch,1,.2),wh=Nt.lerp(wh,1,.2),Hm=!1}cm.scale.set(Sh,Ch,wh),cm.position.y=Nt.lerp(cm.position.y,Th,.2)}function Oh(){if(requestAnimationFrame(Oh),Dh(),uh.update(),bh(),Rm(qm),Hm&&cm){let e=cm.position.clone();e.y+=1.5,uh.target.lerp(e,.12)}if(um.length>0){let e=Hm?.85:0;Bm=Nt.lerp(Bm,e,.12),um.forEach(e=>{e.material.opacity=Bm})}if(rh){let e=rh.geometry.attributes.position.array,t=rh.userData.velocity;for(let n=0;n<e.length;n+=3)e[n]+=t[n],e[n+1]+=t[n+1],e[n+2]+=t[n+2],Math.abs(e[n])>30&&(t[n]*=-1),(e[n+1]>20||e[n+1]<1)&&(t[n+1]*=-1),Math.abs(e[n+2])>30&&(t[n+2]*=-1);rh.geometry.attributes.position.needsUpdate=!0}Jm.render(Km,qm)}Oh(),window.addEventListener(`resize`,()=>{qm.aspect=window.innerWidth/window.innerHeight,qm.updateProjectionMatrix(),Jm.setSize(window.innerWidth,window.innerHeight)});